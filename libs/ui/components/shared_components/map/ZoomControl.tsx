...
import { IconMinus, IconHome, IconPlus } from '@tabler/icons-react'
import { useMap } from 'react-map-gl'

export interface IZoomControlProps {}

const MapControls = ({ children }: { children: ReactNode }) => (
  <div className="flex flex-col overflow-hidden gap-0.5 space-y rounded shadow-lg divide-primary-800">
    {children}
  </div>
)
